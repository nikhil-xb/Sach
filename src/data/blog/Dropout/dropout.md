...
The new network created upon dropout are referred as *thined* network, with a total possiblity of 2n   considering a parent network having n nodes. It can be thought of as training a collection of multiple new networks with extensive weight sharing.

![Standard vs Dropout](./blog/Dropout/fig1.png)
...
![Error rate comparison](./blog/Dropout/fig2.1.png)
...
![Mathematical Expression for standard dropout](./blog/Dropout/fig3.png)
...
![After Dropout](./blog/Dropout/fig4.png)
...
![Representation](./blog/Dropout/fig5.png)
...
![Test phase](./blog/Dropout/fig6.png)
...
![MNIST Error Rate Comparison](./blog/Dropout/fig7.png)
	
![Cifar10, Cifar100 Error Rate Comparison](./blog/Dropout/fig8.png)
